...
export {ApplicationConfig, bootstrapApplication, BrowserModule, createApplication, hydrateApplication, HydrationRendererFactory2, platformBrowser, provideProtractorTestingSupport} from './browser';
