...
import {bind, container, containerRefreshEnd, containerRefreshStart, directiveInject, createViewQuery, loadViewQuery, element, elementContainerEnd, elementContainerStart, elementEnd, elementProperty, elementStart, embeddedViewEnd, embeddedViewStart, load, loadQueryList, reference, registerContentQuery, template, text} from '../../src/render3/instructions';
    ...
    describe('types', () => {
      ...
      it('should query using type predicate and read a specified token', () => {
        ...
        const Cmpt = createComponent(
            ...
            function(rf: RenderFlags, ctx: any) {
              if (rf & RenderFlags.Create) {
                createViewQuery(Child, false, ElementRef);
              }
              if (rf & RenderFlags.Update) {
                let tmp: any;
                queryRefresh(tmp = loadViewQuery<QueryList<any>>()) &&
      ...
      it('should query using type predicate and read another directive type', () => {
        ...
        const Cmpt = createComponent(
            ...
            function(rf: RenderFlags, ctx: any) {
              if (rf & RenderFlags.Create) {
                createViewQuery(Child, false, OtherChild);
              }
              if (rf & RenderFlags.Update) {
                let tmp: any;
                queryRefresh(tmp = loadViewQuery<QueryList<any>>()) &&
        ...
        class App {
          ...
          static ngComponentDef = defineComponent({
            ...
            viewQuery: function(rf: RenderFlags, ctx: App) {
              if (rf & RenderFlags.Create) {
                createViewQuery(MyDirective, false);
                createViewQuery(Service, false);
                createViewQuery(Alias, false);
              }
              if (rf & RenderFlags.Update) {
                let tmp: any;
        ...
        class App {
          ...
          static ngComponentDef = defineComponent({
            ...
            viewQuery: function(rf: RenderFlags, ctx: App) {
              let tmp: any;
              if (rf & RenderFlags.Create) {
                createViewQuery(MyDirective, false, Alias);
              }
              if (rf & RenderFlags.Update) {
                queryRefresh(tmp = loadViewQuery<QueryList<any>>()) && (ctx.service = tmp.first);
              }
    ...
    describe('local names', () => {
      ...
      it('should query for multiple elements and read ElementRef by default', () => {
        ...
        const Cmpt = createComponent(
            ...
            function(rf: RenderFlags, ctx: any) {
              if (rf & RenderFlags.Create) {
                createViewQuery(['foo', 'bar'], undefined);
              }
              if (rf & RenderFlags.Update) {
                let tmp: any;
                queryRefresh(tmp = loadViewQuery<QueryList<any>>()) &&
      ...
      it('should query for <ng-container> and read ElementRef with a native element pointing to comment node',
         () => {
           ...
           const Cmpt = createComponent(
               ...
               function(rf: RenderFlags, ctx: any) {
                 if (rf & RenderFlags.Create) {
                   createViewQuery(['foo'], false, ElementRef);
                 }
                 if (rf & RenderFlags.Update) {
                   let tmp: any;
                   queryRefresh(tmp = loadViewQuery<QueryList<any>>()) &&
      ...
      it('should not descend into <ng-container> when descendants: false', () => {
        ...
        const Cmpt = createComponent(
            ...
            function(rf: RenderFlags, ctx: any) {
              if (rf & RenderFlags.Create) {
                createViewQuery(['foo'], true, ElementRef);
                createViewQuery(['foo'], false, ElementRef);
              }
              if (rf & RenderFlags.Update) {
                let tmp: any;
      ...
      it('should read ViewContainerRef from element nodes when explicitly asked for', () => {
        ...
        const Cmpt = createComponent(
            ...
            function(rf: RenderFlags, ctx: any) {
              if (rf & RenderFlags.Create) {
                createViewQuery(['foo'], false, ViewContainerRef);
              }
              if (rf & RenderFlags.Update) {
                let tmp: any;
                queryRefresh(tmp = loadViewQuery<QueryList<any>>()) &&
      ...
      it('should read TemplateRef from container nodes when explicitly asked for', () => {
        ...
        const Cmpt = createComponent(
            ...
            function(rf: RenderFlags, ctx: any) {
              if (rf & RenderFlags.Create) {
                createViewQuery(['foo'], false, TemplateRef);
              }
              if (rf & RenderFlags.Update) {
                let tmp: any;
                queryRefresh(tmp = loadViewQuery<QueryList<any>>()) &&
      ...
      it('should match on exported directive name and read a requested token', () => {
        ...
        const Cmpt = createComponent(
            ...
            function(rf: RenderFlags, ctx: any) {
              if (rf & RenderFlags.Create) {
                createViewQuery(['foo'], undefined, ElementRef);
              }
              if (rf & RenderFlags.Update) {
                let tmp: any;
                queryRefresh(tmp = loadViewQuery<QueryList<any>>()) &&
      ...
      it('should not add results to selector-based query if a requested token cant be read', () => {
        ...
        const Cmpt = createComponent(
            ...
            function(rf: RenderFlags, ctx: any) {
              if (rf & RenderFlags.Create) {
                createViewQuery(['foo'], false, Child);
              }
              if (rf & RenderFlags.Update) {
                let tmp: any;
                queryRefresh(tmp = loadViewQuery<QueryList<any>>()) &&
      ...
      it('should not add results to directive-based query if only read token matches', () => {
        ...
        const Cmpt = createComponent(
            ...
            function(rf: RenderFlags, ctx: any) {
              if (rf & RenderFlags.Create) {
                createViewQuery(OtherChild, false, Child);
              }
              if (rf & RenderFlags.Update) {
                let tmp: any;
                queryRefresh(tmp = loadViewQuery<QueryList<any>>()) &&
      ...
      it('should not add results to TemplateRef-based query if only read token matches', () => {
        ...
        const Cmpt = createComponent(
            ...
            function(rf: RenderFlags, ctx: any) {
              if (rf & RenderFlags.Create) {
                createViewQuery(TemplateRef as any, false, ElementRef);
              }
              if (rf & RenderFlags.Update) {
                let tmp: any;
                queryRefresh(tmp = loadViewQuery<QueryList<any>>()) &&
      ...
      it('should not add results to the query in case no match found (via TemplateRef)', () => {
        ...
        const Cmpt = createComponent(
            ...
            function(rf: RenderFlags, ctx: any) {
              if (rf & RenderFlags.Create) {
                createViewQuery(TemplateRef as any, false);
              }
              if (rf & RenderFlags.Update) {
                let tmp: any;
                queryRefresh(tmp = loadViewQuery<QueryList<any>>()) &&
